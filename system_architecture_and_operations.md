...
*   **Bộ phận Marketing & CRM (`businessadmin`):**
    ...
    *   Quản lý danh sách hội viên thân thiết và hồ sơ CRM. *Chính sách* tích điểm/khấu trừ điểm do bộ phận này đề xuất, nhưng *tham số* (tỷ lệ tích, trần quy đổi) được `ssadmin` thiết lập trong Central System Settings (UC-30).
...
*   **Nhập kho:** Store Manager lập phiếu nhập kho (`UC-32`) ghi nhận nguyên vật liệu nhập **trực tiếp từ nhà cung cấp bên thứ ba** (sữa, cà phê, hạt, cốc giấy...). Hệ thống không có kho tổng. Dữ liệu tồn kho tăng lên.
...
*   Tra cứu thông tin hội viên qua SĐT, tích điểm và cho phép khách quy đổi điểm loyalty (không có hạng thành viên).
...
*   *Business Admin (`businessadmin`):* Quản lý danh mục menu và giá bán toàn chuỗi, cấu hình định lượng công thức pha chế, tạo và phát hành các chương trình khuyến mãi/Voucher, quản lý hội viên & hồ sơ CRM (không có hạng thành viên).
